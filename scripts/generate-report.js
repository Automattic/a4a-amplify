...
let markdown = `# QA Testing Report - ${websiteName}

**URL:** ${report.url}
**Test Date:** ${new Date(report.timestamp).toLocaleString()}
**Tester:** Automated QA Testing with Playwright
...
This QA report covers ${includeFunctional ? 'functional and design ' : ''}${includePerformance ? 'performance ' : ''}${includeAccessibility ? 'accessibility ' : ''}testing of the ${websiteName} website across mobile (375px) and desktop (1920px) viewports.
...
*Report generated by automated QA testing using Playwright*
